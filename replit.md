...
- **Asset Number Ranges**: Service-type-specific asset numbering system. **Electrical Test & Tag**: Custom frequency-based ranges (Monthly=50001, 3M=40001, 6M=10001, 12M=1, 24M=30001, 5Y=20001). **Emergency Exit Light & Fire Equipment Testing**: Hardcoded ranges (6 Monthly starts at 1, Annually starts at 10001, other frequencies use separate ranges). **RCD Reporting**: Sequential numbering starting at 1. Frequency codes (1M, 3M, 6M, 12M, 24M, 5Y) display only when multiple items share the same asset number across different frequencies. Service type stored in localStorage during session creation ensures correct asset allocation.
