...
- **Microwave Leakage Testing**: Service card available for microwave oven radiation leakage testing (AS/NZS 60335.2.25 compliance standard for both Australia and New Zealand). Currently routes through electrical test workflow; full microwave-specific testing workflow (radiation readings, door seal/interlock checks) available as future enhancement.
